...
const app = {
  ...
  // What a body composition scale reports besides weight and fat. Kept out of bodyStats above on purpose:
  // Goals.getGoalUnit shows anything in that list in the length unit (cm)

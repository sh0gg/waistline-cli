...
> **waistline-cli** is a fork of Waistline created by **sh0gg_**: the screens are replaced by a terminal. See `TERMINAL.md`. Waistline itself is by David Healey; both are GPLv3.
